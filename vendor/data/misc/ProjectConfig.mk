...
#for camera tuning parameter seperate
ifneq ($(filter a32%, $(TARGET_PRODUCT)),)
CUSTOM_IMGSENSOR_VER=ver1_a32lte
else ifneq ($(filter m32%, $(TARGET_PRODUCT)),)
CUSTOM_IMGSENSOR_VER=ver1_m32lte
else 
CUSTOM_IMGSENSOR_VER=ver1_a32lte
endif
CUSTOM_HAL_IMGSENSOR = s5kgw3_mipi_raw hi2021q_mipi_raw sr846d_mipi_raw gc5035_mipi_raw gc5035b_mipi_raw imx355_mipi_raw gc02m1b_mipi_raw gc02m1_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = sr846d_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgw3_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = hi2021q_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5kgw3_mipi_raw hi2021q_mipi_raw sr846d_mipi_raw gc5035_mipi_raw gc5035b_mipi_raw imx355_mipi_raw gc02m1b_mipi_raw gc02m1_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_MAIN2_IMGSENSOR = sr846d_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgw3_mipi_raw
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SUB_IMGSENSOR = hi2021q_mipi_raw
...
MTK_AUDIO_SPEAKER_PATH = smartpa_mitus_sma1305
...
MTK_CAM_ACTIVE_STEREO_SUPPORT = yes
...
MTK_HIGH_FRAME_RATE_DEFAULT_FPS = 90
...
MTK_PROJECT_DTB_NAMES =mediatek/k69v1_64_titan_marmot/Board_00 mediatek/k69v1_64_titan_marmot/Board_01 mediatek/k69v1_64_titan_marmot/Board_02
...
MTK_REFRSH_RATE_SPECIFIC_APP_FPS = yes
...
TEEGRIS_TZAR_SUPPORT = yes
MTK_TEE_GP_SUPPORT = yes
TEEGRIS_PREBUILTS_SUPPORT = no
MTK_MAPI_SUPPORT = yes
MSSI_MTK_MAPI_SUPPORT = yes
MSSI_MTK_DMC_SUPPORT = no
ifneq ($(filter m32%, $(TARGET_PRODUCT)),)
SEC_AUDIO_USE_INVERSEMIC_FOR_CAMCORDER = yes
endif