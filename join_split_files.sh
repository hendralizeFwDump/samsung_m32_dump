...
cat system/system/priv-app/AvatarEmojiSticker_Palette/AvatarEmojiSticker_Palette.apk.* 2>/dev/null >> system/system/priv-app/AvatarEmojiSticker_Palette/AvatarEmojiSticker_Palette.apk
rm -f system/system/priv-app/AvatarEmojiSticker_Palette/AvatarEmojiSticker_Palette.apk.* 2>/dev/null
